...
==                                     //    PC[23]
bnz main_l8                            //    PC[24-26]    tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
txna ApplicationArgs 0                 //    PC[27-29]    examples/application/abi/algobank.py              42      @router.method(no_op=CallConfig.CALL, opt_in=CallConfig.CALL)
method "deposit(pay,account)void"      //    PC[30-35]
==                                     //    PC[36]
bnz main_l7                            //    PC[37-39]    tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
txna ApplicationArgs 0                 //    PC[40-42]    examples/application/abi/algobank.py              66      @router.method
method "getBalance(account)uint64"     //    PC[43-48]
==                                     //    PC[49]
bnz main_l6                            //    PC[50-52]    tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
txna ApplicationArgs 0                 //    PC[53-55]    examples/application/abi/algobank.py              79      @router.method
method "withdraw(uint64,account)void"  //    PC[56-61]
==                                     //    PC[62]
bnz main_l5                            //    PC[63-65]    tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
err                                    //    PC[66]
main_l5:                               //    PC[]
txn OnCompletion                       //    PC[67-68]    examples/application/abi/algobank.py              79      @router.method
int NoOp                               //    PC[69]
==                                     //    PC[70]
txn ApplicationID                      //    PC[71-72]
int 0                                  //    PC[73]
...
load 3                                 //    PC[90-91]    tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
load 4                                 //    PC[92-93]
callsub withdraw_3                     //    PC[94-96]    examples/application/abi/algobank.py              79      @router.method
int 1                                  //    PC[97]
return                                 //    PC[98]
main_l6:                               //    PC[]         tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
txn OnCompletion                       //    PC[99-100]   examples/application/abi/algobank.py              66      @router.method
int NoOp                               //    PC[101]
==                                     //    PC[102]
txn ApplicationID                      //    PC[103-104]
int 0                                  //    PC[105]
...
concat                                 //    PC[128]
log                                    //    PC[129]
int 1                                  //    PC[130]      examples/application/abi/algobank.py              66      @router.method
return                                 //    PC[131]
main_l7:                               //    PC[]         tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
txn OnCompletion                       //    PC[132-133]  examples/application/abi/algobank.py              42      @router.method(no_op=CallConfig.CALL, opt_in=CallConfig.CALL)
int NoOp                               //    PC[134]
==                                     //    PC[135]
txn ApplicationID                      //    PC[136-137]
int 0                                  //    PC[138]
...
load 0                                 //    PC[172-173]  tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
load 1                                 //    PC[174-175]
callsub deposit_1                      //    PC[176-178]  examples/application/abi/algobank.py              42      @router.method(no_op=CallConfig.CALL, opt_in=CallConfig.CALL)
int 1                                  //    PC[179]
return                                 //    PC[180]
main_l8:                               //    PC[]                                                           17      {ROUTER}
txn OnCompletion                       //    PC[181-182]
...
app_local_put                          //    PC[310]                                                        58      App.localPut(sender.address(), Bytes('balance'), App.localGet(sender.address(), Bytes('balance')) + payment.get().amount())
retsub                                 //    PC[311]      tests/integration/sourcemap_monkey_integ_test.py  {L}      {COMPILATION}
                                       //    PC[]         examples/application/abi/algobank.py              66      @router.method
// getBalance                          //
getBalance_2:                          //
txnas Accounts                         //    PC[312-313]                                                    76      user.address()
byte "balance"                         //    PC[314]                                                                Bytes('balance')
