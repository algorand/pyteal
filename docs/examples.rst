...
.. literalinclude:: ../pyteal_examples/signature/atomic_swap.py
    :language: python
...
.. literalinclude:: ../pyteal_examples/signature/split.py
    :language: python
...
.. literalinclude:: ../pyteal_examples/signature/periodic_payment.py
    :language: python
...
.. literalinclude:: ../pyteal_examples/application/vote.py
    :language: python

A reference script that deploys the voting application is below:

.. literalinclude:: ../pyteal_examples/application/vote_deploy.py
    :language: python
...
.. literalinclude:: ../pyteal_examples/application/asset.py
    :language: python
...
.. literalinclude:: ../pyteal_examples/application/security_token.py
    :language: python
