...
This is just a **Lorem Ipsum** place holder showing how to include SVG images.

Let's try and include an SVG (this was created using :any:`drawio` ):

.. image:: PyTealArch.drawio.svg
    :target: PyTealArch.drawio.svg

And another SVG (this was created using :any:`Lucidchart`):

.. image:: PyTealArch.lucid.svg
    :target: PyTealArch.lucid.svg
