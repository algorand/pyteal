...
class Op(Enum):
    ...
    gload             = OpType("gload",             Mode.Signature | Mode.Application, 4)
    gloads            = OpType("gloads",            Mode.Signature | Mode.Application, 4)
    gaid              = OpType("gaid",              Mode.Signature | Mode.Application, 4)
    gaids             = OpType("gaids",             Mode.Signature | Mode.Application, 4)
