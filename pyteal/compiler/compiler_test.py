...
l3:
    ...
    program = Seq([
            For(i.store(Int(0)), i.load() < Int(10), i.store(i.load() + Int(1)))
                .Do(Seq([
                For(i.store(Int(0)), j.load() < Int(4), j.store(j.load() + Int(2)))
                    .Do(Seq([
                    Int(1)
                ]))
            ]))
...
l5:
    ...
    program = Seq([
        For(i.store(Int(0)), i.load() < Int(10), i.store(i.load() + Int(1)))
            .Do(Seq([If(i.load() == Int(4), Continue()),
                     App.globalPut(Itob(i.load()), i.load() * Int(2))
                     ]))
    ])
