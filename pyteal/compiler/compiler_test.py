...
retsub""".strip()
    ...
    expected_csp_with_oc = """#pragma version 8
txn NumAppArgs
int 0
==
bnz main_l8
...
err
main_l5:
callsub approveifoddcaster_5
int 1
return
main_l6:
callsub log1caster_4
int 1
return
main_l7:
callsub emptyreturnsubroutinecaster_3
int 1
return
main_l8:
int 1
...
retsub""".strip()
    ...
    expected_ap_without_oc = """#pragma version 8
txna ApplicationArgs 0
method "add(uint64,uint64)uint64"
==
bnz main_l18
...
retsub""".strip()
    ...
    expected_csp_without_oc = """#pragma version 8
txna ApplicationArgs 0
method "empty_return_subroutine()void"
==
bnz main_l6
