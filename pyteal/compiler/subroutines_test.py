...
def test_spillLocalSlotsDuringRecursion_no_subroutines():
    ...
    spillLocalSlotsDuringRecursion(subroutineMapping, subroutineGraph, localSlots)
...
def test_spillLocalSlotsDuringRecursion_1_subroutine_recursion():
    def sub1Impl(a1):
        return None
...
def test_spillLocalSlotsDuringRecursion_multiple_subroutines_recursion():
    def sub1Impl(a1):
        return None
